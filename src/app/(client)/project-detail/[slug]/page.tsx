      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 mt-[-120px]">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            {/* Title with Gradient */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black mb-6 bg-gradient-to-r from-white via-cyan-200 to-cyan-400 bg-clip-text text-transparent leading-tight drop-shadow-lg">
              {project.title}
            </h1>
