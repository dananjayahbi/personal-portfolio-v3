        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {images.map((item, index) => (
            <button
              ...
              className="group relative aspect-video rounded-xl overflow-hidden bg-slate-800/50 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 shadow-lg hover:shadow-cyan-500/20 cursor-pointer"
            >
              <Image
                src={item.url}
