...
import { initialExperimentState } from "../experiment-state";
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 px-5 py-4 md:px-6">
      <div className="text-sm text-white/70">
        {pending ? 'Publishing your experiment…' : success ?? 'Your new experiment will shine on the portfolio once saved.'}
      </div>
      <button
        type="submit"
        ...
        {asset?.preview ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 py-6 text-center">
            ...
            <p className="text-xs text-white/50">
              Choose an image from your device. It will upload to Cloudinary when you publish the experiment.
            </p>
          </div>
        )}
      </div>
    ...
    <div className="flex flex-col gap-2 text-sm text-white/70">
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs text-white/50">
            Pick one or more images. They upload after you submit the experiment, keeping Cloudinary tidy.
          </p>
        </div>
...
export function ExperimentForm() {
  const [state, formAction] = useActionState(createExperiment, initialExperimentState);
